            ...
            <div class="aa-product-catg-body">
              ...
              <ul class="aa-product-catg">
                <?php
                    ...
                    echo "<figure>";
                    echo "<tr>";
                        echo '<td> <a class="aa-product-img" href="product-detail.php?id='.$row['product_id'].'"> <img src="admin/resources/images/'.$row['image'].'" height="300" width="250" /></a></td>';
                        echo '<td> <a class="aa-add-card-btn" data-type="add" data-qty=1 data-product_id='.$row['product_id'].' href="#">Add To Cart</a></td>';
                        echo '<figcaption>';
                        echo '<td> <h4 class="aa-product-title"><a href="#"> ' .$row["name"]. ' </a></h4></td>';
                        echo '<td> <span class="aa-product-price">'.$row['price'].'</span><span class="aa-product-price"><del>'.$row['price'].'</del></span></td>';
                        echo '<td> <p class="aa-product-descrip">'.$row['discription'].'</p></td>';
                        echo '</figcaption>';
                      echo '</figure>';
